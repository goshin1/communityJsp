...
<head>
    ...
    <link href="style/jobs_write.css?ver=3" type="text/css" rel="stylesheet">
...
<body>
    ...
    <div id="content">
        ...
        <div id="notice">
            <div id="main_post">
                <form method="get" action="aaaa.jsp">
            ...
            <form name="jobBoard" id="write" method="post" action="jobs_writeChain.jsp" enctype="multipart/form-data">
